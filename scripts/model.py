...
def callback(data: Float32MultiArray):
    ...
    input_img = data[:-3]
    # if count % 20 == 0:
    #     with open('input_vec_{}.json'.format(count), 'w') as f:
    ...
    cost_map = model(input_img, map_design)
...
if __name__ == '__main__':
    print("Start Model Node")
    check_point = get_checkpoint_name(15,199)
    model = load_model(15,check_point)
    preheat_model()
